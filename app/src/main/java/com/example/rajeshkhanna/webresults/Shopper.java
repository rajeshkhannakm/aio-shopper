...
public class Shopper extends AppCompatActivity {
    ...
    public RelativeLayout lock_screen;
...
//        tab[2] = new TabFragment();
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Jabong"));
...
//        final PagerAdapter adapter = new PagerAdapter (getSupportFragmentManager(), tabLayout.getTabCount());
        ...
        menu_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Shopper.this);
...
//                });
    ...
    public void onEnterClick(View view) {
        if (enter_button.getText().equals("Save")) {
            ...
            ((RelativeLayout) findViewById(R.id.shopper)).removeView(lock_screen);
...
//        tab[2].load(amazon_url + (editText.getText().toString()));
    ...
    public void removeLayout() {
        ((RelativeLayout) findViewById(R.id.shopper))
        ...
        public Fragment getItem(int position) {
            ...
            if (userSites.size() <= 0) {
                ...
                switch (position) {
                    case 0:
                        tab[0] = new TabFragment();
                        tab[0].setUrl("https://www.flipkart.com/");
                        return tab[0];
                    case 1:
                        tab[1] = new TabFragment();
                        tab[1].setUrl("http://www.jabong.com/");
                        return tab[1];
                    case 2:
                        tab[2] = new TabFragment();
                        tab[2].setUrl("http://www.amazon.in/");
                        return tab[2];
                    default:
                        return null;
                }
